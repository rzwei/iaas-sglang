...
class RotaryEmbedding(CustomOp):
    ...
    def forward_triton(
        ...
        hcdbg.jack_print(f'hcdbg: (python-sglang) RotaryEmbedding:forward_triton(): DONE (Triton) offsets = {offsets}') # debug
        if offsets is not None:
        ...
        # ops.rotary_embedding( # from vllm import _custom_ops as ops
        #     positions,
        #     query,
        #     key,
        #     self.head_size,
...
def get_rope(
    ...
    hcdbg.jack_print(f'hcdbg: (python-sglang) rotary_embedding.get_rope():') # debug
    ...
    hcdbg.jack_print(f'hcdbg: (python-sglang) rotary_embedding.get_rope(): rope_scaling = {rope_scaling}') # debug
