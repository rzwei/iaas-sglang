...
class DeepseekV2AttentionMLA(nn.Module):
    ...
    def forward_absorb(
        ...
        if self.w_kc.dtype == torch.float8_e4m3fnuz:
            ...
            q_nope_val, q_nope_scale = input_to_float8_transpose(
                q_nope, torch.float8_e4m3fn
            )
            q_nope_out = bmm_fp8(
        ...
        if self.w_vc.dtype == torch.float8_e4m3fnuz:
            ...
            attn_output_val, attn_output_scale = input_to_float8_transpose(
                attn_output, torch.float8_e4m3fn
            )
