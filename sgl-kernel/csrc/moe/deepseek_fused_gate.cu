...
__global__ void
deepseekv3_fused_gate_kernel(void* input, void* bias, float* output_ptr, int32_t* indices_ptr, int num_rows, int k) {
...
std::vector<at::Tensor> deepseekv3_fused_gate(at::Tensor& input, at::Tensor& bias) {
  ...
  deepseekv3_fused_gate_kernel<VPT, NUM_EXPERTS, THREADS_PER_ROW, ROWS_PER_WARP, ROWS_PER_CTA, WARPS_PER_CTA>
